            ...
            <>
                ...
                <Form {...form}>
                        ...
                        <div className="space-y-4 text-gray-700">
                          ...
                          <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                              <li>
                                Manter informações precisas e atualizadas sobre
                                suas arenas
                              </li>
                              <li>
                              ...
                              <li>
                                Honrar todas as reservas confirmadas pelos
                                clientes
                              </li>
                              <li>
                          ...
                          <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                              <li>
                                Você pode gerenciar múltiplas arenas na
                                plataforma
                              </li>
                              <li>
                                Cada arena pode ter múltiplas quadras com
                          ...
                          <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                              <li>
                                Clientes podem cancelar reservas até 24 horas
                                antes do horário
                              </li>
                              <li>
                              ...
                              <li>
                                Em caso de problemas recorrentes, a arena pode
                                ser suspensa
                              </li>
                            </ul>
                          </div>
                          ...
                          <div>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                              <li>
                                Seus dados pessoais e comerciais são protegidos
                                por nossas políticas de privacidade
                              </li>
                              <li>
                                Não compartilharemos informações com terceiros
                                sem sua autorização
                              </li>
                              <li>
                                Você tem acesso aos dados de reservas e
                                relatórios de uso
                              </li>
                            </ul>
                          </div>
                          ...
                          <FormItem>
                            <label className="flex items-start gap-3 cursor-pointer mb-2">
                              ...
                              <span className="text-sm text-gray-700">
                                ...
                                acima. Estou ciente das minhas responsabilidades
                                como proprietário de arena na plataforma Arena
                                Manager.
                              </span>
                            </label>
                            <FormMessage />
                  ...
                  {step === 2 && (
                    <div>
                      ...
                      <p className="text-gray-600 mb-6">
                        Escolha um nome atrativo para sua arena. Este será o
                        nome que os clientes verão ao procurar por locais para
                        jogar.
                      </p>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <p className="text-xs text-gray-500 mt-1">
                                Dica: Use um nome fácil de lembrar e que
                                represente sua arena
                              </p>
                              <FormMessage />
                            </FormItem>
                          )}
                  ...
                  {step === 3 && (
                    <div>
                      ...
                      <p className="text-gray-600 mb-6">
                        ...
                        ajudará os clientes a encontrarem sua arena mais
                        facilmente.
                      </p>
                  ...
                  {step === 4 && (
                    <div>
                      ...
                      <p className="text-gray-600 mb-6">
                        Forneça o endereço completo da sua arena. Isso é
                        essencial para que os clientes possam localizar e
                        visitar sua arena.
                      </p>
              ...
              <div className="mt-6 text-center text-sm text-gray-600">
                <p>
                  ...
                  <strong>Painel do Proprietário</strong> onde poderá gerenciar
                  suas quadras, horários e visualizar relatórios.
                </p>
              </div>
            </>
          )}
